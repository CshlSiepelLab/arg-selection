...
def infer_ARG_fea(pos_ls, geno_mtx, put_sel_var, var_pos, Ne):
    ...
    t_at_var = ts_inferred.at(var_ppos)
    t = t_at_var.newick(precision=1)
    ...
    feature_mtx = xtract_fea(dp_tree, put_sel_var, 1) # 2 x 1000
